...
local function CreateGUI(title)
    ...
    disagreeButton.BackgroundColor3 = Color3.fromRGB(355, 356, 355)
    ...
    agreeButton.BackgroundColor3 = Color3.fromRGB(0.678, 0.847, 0.902)
    agreeButton.Text = "同意"
    agreeButton.TextColor3 = Color3.new(255,0,0)
